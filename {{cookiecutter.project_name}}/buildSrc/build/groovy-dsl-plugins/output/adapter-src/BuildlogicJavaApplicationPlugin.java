...
/**
 * Precompiled buildlogic.java-application script plugin.
 **/
@SuppressWarnings("DefaultPackage")
public class BuildlogicJavaApplicationPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> pluginsBlockClass = Class.forName("cp_precompiled_BuildlogicJavaApplication").asSubclass(BasicScript.class);
            ...
            target.getPluginManager().apply("buildlogic.java-core");


            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_BuildlogicJavaApplication").asSubclass(BasicScript.class);
